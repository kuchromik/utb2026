<script>
    ...
    function getInvoiceEmail() {
        ...
        // Priorisierung: job.billingEmail > job.contactEmail > customer.invoiceMail > customer.email
        return job.billingEmail || job.contactEmail || customer.invoiceMail || customer.email || '';
    }
